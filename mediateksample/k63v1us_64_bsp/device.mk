...
PRODUCT_COPY_FILES += device/mediateksample/k63v1us_64_bsp/android.hardware.telephony.gsm.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.telephony.gsm.xml
